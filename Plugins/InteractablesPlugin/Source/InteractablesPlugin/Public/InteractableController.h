...
class INTERACTABLESPLUGIN_API UInteractableController : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	TMap<ECommonInputType, FText> PrimaryInputDisplayTextMap;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input")
	TMap<ECommonInputType, FText> SecondaryInputDisplayTextMap;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input")
	UInputAction* PrimaryInteractInputAction;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input")
	UInputAction* SecondaryInteractInputAction;
